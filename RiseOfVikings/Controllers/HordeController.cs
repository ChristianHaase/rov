...
namespace RiseOfVikings.Controllers
{
    public class HordeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                News = _facade.GetForumRepo().AllThreadsForSubforum(4)
            };
            return View(model);
        }
        ...
        public ActionResult AddNewVideoConfirmed(Videos video)
        {
            ...
            return RedirectToAction("Videos", "Horde");
        }
        ...
        public ActionResult Forum()
        {
            if (Session["User"] != null)
            {
                var model = new ForumViewModel()
                {
                    AllSubforums = _facade.GetForumRepo().AllSubforumsForForum(2),
                    LoggedInUser = Session["User"] as User
                };
                return View(model);
        ...
        public ActionResult CreateSubforum()
        {
            var model = new ForumViewModel()
            {
                SelectedForum = _facade.GetForumRepo().AllForums().FirstOrDefault(x => x.id == 2)
            };
            return View(model);
        }
        ...
        public ActionResult CreateSubforumConfirmed(Subforum subforum, int forum)
        {
            if (subforum.description == null || subforum.subforum_name == null)
            {
                ...
                return RedirectToAction("CreateSubforum", "Horde");
            }
            if (forum == 1)
            {
                _facade.GetForumRepo().CreateSubforumHorde(subforum);
            ...
            return RedirectToAction("Forum", "Horde");
        }
        ...
        public ActionResult ChangeAboutConfirmed(int id, string about)
        {
            ...
            return RedirectToAction("About", "Horde");
        }
    }
}